...
public class HipHopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create a list of hip hop songs.
        ArrayList<Song> songs = new ArrayList<>();
        songs.add(new Song(getString(R.string.hip_hop_song1) , getString(R.string.hip_hop_artist1)));
        songs.add(new Song(getString(R.string.hip_hop_song2) , getString(R.string.hip_hop_artist2)));
        songs.add(new Song(getString(R.string.hip_hop_song3) , getString(R.string.hip_hop_artist3)));
        ...
        returnToMenu.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent main = new Intent(HipHopActivity.this, MainActivity.class);
                startActivity(main);
            }
        });
